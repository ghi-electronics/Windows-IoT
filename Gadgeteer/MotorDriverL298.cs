...
namespace GHIElectronics.UWP.Gadgeteer.Modules {
    public class MotorDriverL298 : Module {
        private GSI.PwmOutput[] pwms;
        private GSI.DigitalIO[] directions;
        ...
        protected async override Task Initialize(ISocket parentSocket) {
            ...
            this.directions = new GSI.DigitalIO[] {
            ...
            this.pwms[0].Enabled = true;
            this.pwms[1].Enabled = true;
        }
        ...
        public void SetSpeed(Motor motor, double speed) {
            ...
            this.pwms[(int)motor].Set(this.Frequency, speed > 0 ? speed : 1 + speed);
        }
    }
}