...
namespace GHI.Athens.Modules {
	public class TempHumidSI70 : Module {
		...
		protected async override Task Initialize(Socket parentSocket) {
			this.i2c = await parentSocket.CreateI2CDeviceAsync(new Windows.Devices.I2C.I2CConnectionSettings(TempHumidSI70.I2C_ADDRESS, Windows.Devices.I2C.I2CBusSpeed.StandardMode, Windows.Devices.I2C.I2CAddressingMode.SevenBit), SocketPinNumber.Five, SocketPinNumber.Four);
		}
