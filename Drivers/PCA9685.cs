...
namespace GHI.Athens.Modules {
    ...
    public class PCA9685 {
        ...
        private DigitalIO outputEnable;
        private byte[] write5;
        private byte[] write2;
        private byte[] write1;
        private byte[] read1;
        ...
        public async Task Initialize(I2cDevice device, DigitalIO outputEnable) {
            ...
            this.outputEnable.DriveMode = WD.Gpio.GpioPinDriveMode.Output;
            this.outputEnable.Write(false);
        ...
        public bool OutputEnabled {
            get {
                return !this.outputEnable.Read();
            }
            set {
                this.outputEnable.Write(!value);
            }
        }
