...
using GNI = GHIElectronics.UWP.GadgeteerCore.NativeInterfaces;
using GSI = GHIElectronics.UWP.GadgeteerCore.SocketInterfaces;

namespace GHIElectronics.UWP.Gadgeteer.Mainboards {
    public class FEZCream : Module {
        ...
        private class IndirectedDigitalIO : GSI.DigitalIO {
            private int pin;
        ...
        private class IndirectedAnalogIO : GSI.AnalogIO {
            private int channel;
            private ADS7830 analog;
        ...
        private class IndirectedPwmOutput : GSI.PwmOutput {
            private int channel;
            private PCA9685 pwm;
